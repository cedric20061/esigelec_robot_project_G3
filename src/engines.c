...
void engines_configs(){
    ...
    TA1CCR0 = 10000; // fréquence de 100kHz < 500kHz (voir doc)
...
void action_robot(int action)
{
    ...
    switch(action)
    {
        ...
        case ACTION_DROITE :
            ...
            P2OUT &= ~BIT5;	//sens avant roue droite (a completer)
            TA1CCR1 = PERCENT_CONTROL(50); //activation roue gauche
            TA1CCR2 = PERCENT_CONTROL(30); //activation roue droite
        ...
        case ACTION_GAUCHE :
            ...
            P2OUT |= BIT1;	//sens avant roue gauche (a completer)
            P2OUT |= BIT5;	//sens avant roue droite (a completer)
            TA1CCR1 = PERCENT_CONTROL(30); //activation roue gauche
            TA1CCR2 = PERCENT_CONTROL(50); //activation roue droite
            break;
        case ACTION_ARRET :
            is_moving = 0;
        ...
        case ACTION_FREINER :
            ...
            P2OUT |= BIT5;	//sens avant roue droite (a completer)
            for(i=0; i<2; i++){
                TA1CCR1 = PERCENT_CONTROL(VALUE_TO_PERCENT(TA1CCR1) - 50);
                TA1CCR2 = PERCENT_CONTROL(VALUE_TO_PERCENT(TA1CCR2) - 50);
